...
export default function JotaiPageNavigation() {
	...
	const handleAddPage = () => {
		pageReducer(pages, setPages,'ADD_PAGE', {template: 'titleSubtitle'})
	};
	...
	const handleDeletePage = (e, indexToDelete) => {
		...
		const deletePage = () =>
			pageReducer(pages, setPages, 'DELETE_PAGE', { indexToDelete: indexToDelete })
